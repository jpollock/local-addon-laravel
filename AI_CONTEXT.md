...
#### Dark Mode Support (December 9, 2024)
...
#### Jetstream & Breeze API Support (December 9, 2024)
...
1. **`src/common/security.ts`**
   ...
   - Proper path escaping for AppleScript (single quotes to `'\''`)
